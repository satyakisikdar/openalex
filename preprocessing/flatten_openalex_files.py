...
csv_files = dict(
    institutions={
        ...
        "associated_institutions": {
            "name": os.path.join(
                CSV_DIR, "institutions_associated_institutions.csv.gz"
            ),
...
DTYPES = {
    ...
    "authorships": dict(
        work_id="int64",
        author_position="category",
        author_id="Int64",
        author_name=STRING_DTYPE,
        ...
        raw_affiliation_string=STRING_DTYPE,
        publication_year="Int16",
    ...
    "referenced_works": dict(work_id="int64", referenced_work_id="int64"),
    "related_works": dict(work_id="int64", related_work_id="int64"),
    "concepts": dict(
        work_id="int64",
        publication_year="Int16",
        concept_id="int64",
    ...
    "abstracts": dict(
        ...
        publication_year="Int16",
        title=STRING_DTYPE,
        abstract=STRING_DTYPE,
    ),
    "ids": dict(
        work_id="int64",
        openalex=STRING_DTYPE,
        doi=STRING_DTYPE,
        mag="Int64",
        pmid=STRING_DTYPE,
        pmcid=STRING_DTYPE,
    ...
    "biblio": dict(
        ...
        volume=STRING_DTYPE,
        issue=STRING_DTYPE,
        first_page=STRING_DTYPE,
        last_page=STRING_DTYPE,
    ),
    "mesh": dict(
        work_id="int64",
        descriptor_ui=STRING_DTYPE,
        descriptor_name=STRING_DTYPE,
        qualifier_ui=STRING_DTYPE,
        qualifier_name=STRING_DTYPE,
        is_major_topic=STRING_DTYPE,
    ),
}
...
def flatten_authors(files_to_process: str | int = 'all'):
...
def flatten_authors_concepts(files_to_process: str | int = 'all'):
    skip_ids = get_skip_ids('authors')
    file_spec = csv_files['authors']
...
def flatten_authors_hints(files_to_process: str | int = 'all'):
    skip_ids = get_skip_ids('authors')
    file_spec = csv_files['authors']
